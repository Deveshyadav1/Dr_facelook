        ...
        <tbody class="text-left text-gray-600">
            ...
            <tr>
                ...
                <th class="w-1/2 mb-4 text-xs font-extrabold tracking-wider flex flex-row items-left">
                    <div class="w-8 h-8 overflow-hidden rounded-full">
                        <img height="100%" width="100%" src="" class="profile_photo_url" alt="">
                    </div>
                    <p class="ml-3">name</p>
                </th>
                <!-- name -->
            ...
            <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-left">Name</th>

            <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-left">Phone</th>

            <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-left">Date


                <!-- <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-right"></th> -->


              <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-center">

                <div class="flex flex-row justify-center items-center">
                  <a href="/chatify"> <img height="35px" width="35px" src="https://i.pinimg.com/1200x/ee/ba/26/eeba26add7248f938ebd1b97fa41fba3.jpg" class="profile_photo_url" alt=""> </a> &nbsp;&nbsp;
