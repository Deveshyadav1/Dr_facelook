...
<?php
 ...
 $createdAt = Carbon::parse($message->created_at);
    $now = Carbon::now();
     $timeDiff = $createdAt->diffForHumans($now);
    // Output the time difference

?>
            <!-- item -->
            <a href="/chatify/<?php echo $message->from_id?>" class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out">
              ...
              <div class="flex-1 flex flex-rowbg-green-100">
                <div class="flex-1">
                  <h1 class="text-sm font-semibold">{{$message->name}}</h1>
                  <p class="text-xs text-gray-500">{{$message->body}}</p>
                </div>
                <div class="text-right text-xs text-gray-500">
...
@endforeach            
          ...
          <!--   <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out" href="#">
           ...
           <!--  <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out" href="#">
            ...
            <hr>
            <div class="px-4 py-2 mt-2">
              <a href="/chatify" class="border border-gray-300 block text-center text-xs uppercase rounded p-1 hover:text-teal-500 transition-all ease-in-out duration-500">
                view all
              </a>
            </div>
            <!-- end bottom -->
...
<div class="h-screen flex flex-row flex-wrap">
  ...
  <div id="sideBar" class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 p-6 flex-none w-64 md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
    ...
    <div class="flex flex-col">
      ...
      <!-- link -->
      <a href="/pharmacy_vendors" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
